...
const BOManageImage3 = () => {
    ...
    const fetchImage2 = async () => {
        ...
        try {
            const response = await fetch(`${GOHERE_SERVER_URL}/businessowner/getImageThree`, {
                method: 'GET',
                headers: {
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const token = await AsyncStorage.getItem('token');
            const response = await fetch(`${GOHERE_SERVER_URL}/businessowner/updateImageThree`, {
                method: 'PATCH',
                headers: {
                    'Authorization': `Bearer ${token}`,
